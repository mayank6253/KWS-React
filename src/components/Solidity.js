  ...
  return (
    <>
      ...
      <div className="advantages container">
        <h3 className="advantage">Benefits of Hiring Solidity developer</h3>
        <div className="hyper">
          <p className="lending">
            Outsource a team One can outsource various responsible functions
            related to blockchain, smart contracts, and application development
            services. The clients can hire solidity developers on monthly,
            hourly, or fixed cost.
          </p>

          <p className="lending">
            100% client satisfaction Hire solidity developers with impressive
            coding skills in software programs who work with dedication for full
            customer satisfaction. Our highly motivated and creative team
            understands business needs and provide work in a secured.
          </p>

          <p className="lending">
            Easy communication Our solidity developers work with diligence in
            the non-disclosure agreement. All this is done with an easy and
            direct communication network between clients and developers.
          </p>
          <p className="lending">
            Integrity &transparency Solidity developers in our teamwork with
            zeal towards the project provided by the client and the daily code
            validation and timely reporting maintain the transparency.
          </p>
        </div>
      </div>
